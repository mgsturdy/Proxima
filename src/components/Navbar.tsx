...
const navLinks = [
  ...
  { name: "Intervention", href: "/interventions" },
...
export default function Navbar() {
  ...
  const hasHeroSection = pathname === "/" || pathname === "/science" || pathname === "/diagnostics" || pathname === "/interventions" || pathname === "/practitioners" || pathname === "/about";
