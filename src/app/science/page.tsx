  ...
  return (
    <div className="min-h-screen bg-primary text-primary">
      ...
      <section className="bg-proxima-cream pt-20 md:pt-24">
        <div className="section-narrow pt-8 md:pt-8 pb-0">
          <motion.div
      ...
      <section className="relative flex flex-col bg-proxima-cream overflow-hidden">
        ...
        <div className="flex-grow flex flex-col lg:flex-row items-center justify-center px-0 md:px-4 gap-4 lg:gap-8 py-0 md:py-2 lg:pt-4">
          ...
          >
            <span className="font-mono text-sm uppercase tracking-wider text-proxima-black/50 [writing-mode:vertical-lr] rotate-180">Scroll to explore</span>
            <motion.div
              animate={{ y: [0, 8, 0] }}
          ...
          <motion.div
            ...
            className="hidden lg:flex flex-col items-center gap-2 shrink-0"
          >
            <span className="font-mono text-sm uppercase tracking-wider text-proxima-black/50 [writing-mode:vertical-lr]">Scroll to explore</span>
            <motion.div
              animate={{ y: [0, 8, 0] }}
              transition={{ repeat: Infinity, duration: 1.5 }}
            >
