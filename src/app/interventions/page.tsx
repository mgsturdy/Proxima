          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-4">
              <div className="sticky top-32">
                ...
                <p className="text-proxima-black/60">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-white border border-proxima-black/10 p-8"
                  >
                    <div className="flex items-start justify-between mb-6">
                      <div>
                        <p className="font-mono text-xs text-proxima-black/40 uppercase tracking-wider mb-1">{item.category}</p>
                        <h3>{item.title}</h3>
                      </div>
                      <Image src={item.icon} alt="" width={32} height={32} className="opacity-30" />
                    </div>
                    <p className="text-proxima-black/70 mb-6">{item.content}</p>
        ...
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-5">
              <span className="chapter-number text-proxima-offwhite/5">02</span>
              <h2 className="text-proxima-offwhite mt-4 mb-2">Therapeutic Filtration</h2>
              <p className="section-label text-proxima-offwhite/40 mb-6">INUSpheresis®</p>
              
              <div className="prose-editorial text-proxima-offwhite/70 mb-8">
                <p>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <div key={i} className="flex justify-between border-b border-proxima-offwhite/10 pb-3">
                    <span className="font-mono text-xs text-proxima-offwhite/40 uppercase">{item.label}</span>
                    <span className="font-sans text-sm text-proxima-offwhite/80">{item.value}</span>
                  </div>
                ))}
              </div>

              <Link href="/practitioners" className="inline-flex items-center gap-2 font-sans text-sm font-medium text-proxima-offwhite/60 hover:text-proxima-offwhite transition-colors">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="font-mono text-xs text-proxima-offwhite/40 mt-4">
